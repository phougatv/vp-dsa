...
public class InsertionSortTest
{
    ...
    public void Sort_WhenArrayIsEmpty_ReturnsTheArray()
    {
        ...
        // Act
        var actual = insertionSort.Sort(array);
    ...
    public void Sort_WhenArrayHasOnlyOneItem_ReturnsTheArray()
    {
        ...
        // Act
        var actual_1 = insertionSort.Sort(array_1);
        var actual_2 = insertionSort.Sort(array_2);
        var actual_3 = insertionSort.Sort(array_3);
    ...
    public void Sort_WhenArrayHasTwoOrMoreItems_ReturnsTheSortedArray()
    {
        ...
        var actual_2 = insertionSort.Sort(array_2);
        var actual_3 = insertionSort.Sort(array_3);
        var actual_4 = insertionSort.Sort(array_4);
